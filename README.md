...
In this coding bootcamp assignment, I created a weather forecast app with the 3rd-party Open Weather API to search for 5-days forecasts everywhere around the world. 
...
This was definitely a very challenging assignment, especially getting the local storage set for each new button as it was generated through javascript, but my understanding of the language has been greatly enhanced as a result of doing it.   
